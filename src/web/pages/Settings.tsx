  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl">
      ...
      <section className="space-y-2">
        <h2 className="text-sm font-medium text-gray-700 dark:text-gray-300">Defaults</h2>
        <pre
      ...
      {health && (
        <section className="space-y-2">
          <h2 className="text-sm font-medium text-gray-700 dark:text-gray-300">Daemon</h2>
